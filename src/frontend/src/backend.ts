...
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: bigint, arg2: string, arg3: string, arg4: Category): Promise<void> {
    ...
    async getBestSellerProducts(): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.getBestSellerProducts();
                return from_candid_vec_n3(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_variant_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "featured" in value ? Category.featured : "standard" in value ? Category.standard : "bestSeller" in value ? Category.bestSeller : value;
}
